  ...
  const depositChannels = [
    {
      id: 1,
      name: "Payment",
      image: "https://dummyimage.com/150/fff/000",
    },
    {
      id: 2,
      name: "Payment",
  ...
  return (
    <div>
      ...
      <div className={styles.channelDiv}>
        ...
        <div className={styles.channelBankDiv}>
          {depositChannels.map((channel) => (
            <div>
              <img src={channel.image} alt="" className={styles.bankImage} />
            </div>
          ))}
        </div>
        <div className={styles.channelInfoDiv}>
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            className="lucide lucide-circle-alert shrink-0"
          >
          ...
          <p>
            If your deposit attempt fails, please try using a different deposit
            channel.
          </p>
        </div>
      </div>
      <div className={styles.selectBtnDiv}>
        <Menu>
          <MenuButton className={styles.selectBtn}>
            <div className={styles.selectBtnLabel}>
              <p>
                Bank Account <span>*</span>
              </p>
              <h1>Maybank Berhad</h1>
            </div>
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <MenuItems as="div" className={styles.selectContentDiv}>
            {banks.map((bank) => (
              <MenuItem as="div" className={styles.selectItem}>
                <p>{bank.name}</p>
              </MenuItem>
            ))}
          </MenuItems>
      ...
      <div style={{ padding: "2rem", marginTop: "1rem" }}>
        ...
        <p style={{ fontSize: "1.8rem", marginTop: "1rem" }}>
          Minimum MYR 30 or Maximum MYR 30,000
        </p>
      </div>
    </div>
  );
